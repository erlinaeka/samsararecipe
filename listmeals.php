...
<body>
    ...
    <div class="container">
        <div class="row mt-4">
            <div class="col">
                <a href="search.php" class="btn btn-dark btn-lg active" role="button" aria-pressed="true" style="font-size: 16px;">Search</a>
                <p class="mt-2">Klik Search Button Above to Find More Meals Information</p>
            </div>
        </div>
            ...
            <div class="col">
                <table class="table table-bordered">
                    <thead class="thead-dark">
                        <tr>
                            <th style="width: 10%;" scope="col" class="text-center">Meal ID</th>
                            <th style="width: 35%;" scope="col" class="text-center">Meal</th>
                            <th style="width: 15%;" scope="col" class="text-center">Name</th>
                            <th style="width: 20%;" scope="col" class="text-center">Category</th>
                            <th style="width: 20%;" scope="col" class="text-center">Tags</th>

                        </tr>
                    </thead>
                    <?php foreach ($array as $meals) : ?>
                        <tbody>
                            <tr>
                                <td><?= $meals["idMeal"]; ?></td>
                                <td> <img src="<?= $meals["strMealThumb"]; ?>" style="width: 40%;"></td>
                                <td><?= $meals["strMeal"]; ?></td>
                                <td><?= $meals["strCategory"]; ?></td>
                                <td><?= $meals["strTags"]; ?></td>
                            </tr>
