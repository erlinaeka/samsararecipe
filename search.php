...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-item nav-link mr-12px active" href="index.html">Home</a>
    ...
    <div class="container">
        <section id="all-food">
            <h2 class="text-center mt-5">Search Meal</h2>
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="input-group mb-5 mt-5">
                        <input type="text" class="form-control" placeholder="Meal Name....." id="search-input">
                        <button class="btn btn-dark" onclick="getSearchValue()" type="button" id="search-button">Search</button>
                    </div>
                </div>
            </div>
            ...
            <div class="row container" id="meal-list">
